        ...
        <div class="panel-body">
            <table border="0" class="table datatable table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th scope="col" class="">Categorie</th>
                    <th scope="col" class="">Université</th>
                ...
                <?php foreach ($recherche as $k => $v): ?>
                    <a href="universite/presentation.php?univ_id=1"> <tr rel="<?php echo $v->id ?>" id="<?php echo $v->id_u ?>" style="cursor: pointer;">
                            <td><?php echo $v->Filiere; ?></td>
...
<form class="form-horizontal">
    <div class="panel panel-default">
        ...
        <div class="panel-body form-group-separated">
            ...
            <div class="form-group" id="universite">
                <label class="col-md-3 col-xs-12 control-label">Université</label>
                <div class="col-md-6 col-xs-12">
                    <select class="form-control" name="srch_universite" id="srch_universite">
                        <option value="">Tout&hellip;</option>
                        <?php foreach ($universite as $k => $v): ?>
                            <option value="<?php echo $v->UNIVERSITE_ID; ?>" <?php getSticky(2,'srch_universite',$v->UNIVERSITE_ID) ?>><?php echo $v->NOM; ?></option>
                        <?php endforeach; ?>
                    </select>
                    <span class="help-block">Quel université</span>
                </div>
            </div>
            ...
            <div class="form-group" id="categorie">
                ...
                <div class="col-md-6 col-xs-12">
                    <select class="form-control select" name="srch_categorie" id="srch_categorie">
                        ...
                        <span class="help-block">A quel catégorie ça appartient</span>
                </div>
            </div>
