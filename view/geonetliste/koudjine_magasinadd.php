...
$page_for_layout = ($position == 'Ajouter') ? 'Ajouter un magasin' : 'Modifier un magasin';
...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="block">
            <h4 style="padding: 10px 20px;background-color: #2d3945;color: white;">Nouveau magasin</h4>
            <form id="jvalidate" role="form" class="form-horizontal" action="javascript:enregistrer_magasin('<?php echo $position; ?>','<?php if ($position == 'Modifier')  echo $magasin->id;
                                                                                                                                            else echo ""; ?>');">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-md-3 control-label">Nom:</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="nom" id="nom" value="<?php if ($position == 'Modifier') echo $magasin->nom; ?>" placeholder="Nom" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="code" id="code" value="<?php if ($position == 'Modifier') echo $magasin->code; ?>" placeholder="Code" />
                            <span class="help-block">exemple: 89489233</span>
                        </div>
                    </div>
                    <div class="btn-group pull-right">
                        <a class="btn btn-primary" style="margin-right: 20px" href="<?php echo Router::url('bouwou/geonetliste/magasin'); ?>">Annuler</a>
