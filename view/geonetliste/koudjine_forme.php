<!-- <?php
        ...
        $script_for_layout = '<script type="text/javascript" src="' . BASE_URL . '/koudjine/js/plugins/datatables/jquery.dataTables.min.js"></script>
                ...
                <script type="text/javascript" src="' . BASE_URL . '/koudjine/js/formsForme.js"></script>
                <script>
...
<div class="row">
    <div class="col-md-4">
        ...
        <div class="block">
            <h4 class="titre" style="padding: 10px 20px;background-color: #2d3945;color: white;">Nouveau Forme</h4>
                    ...
                    <table class="table datatable table-bordered table-striped table-actions">
                        ...
                        <tbody>
                            <?php foreach ($geonetliste as $k => $v) : ?>
                                <tr id="<?php echo $v->idforme; ?>">
                                    <td><strong><?php echo $v->nomforme; ?></strong></td>
                                    <td><?php echo $v->codeforme; ?></td>
                                    <td>
                                        <button class="btn btn-default btn-rounded btn-sm" data-toggle="tooltip" data-placement="top" title="Modifier" onclick="update_row_forme(<?php echo $v->idforme; ?>)"><span class="fa fa-pencil"></span></button>
                                        <button class="btn btn-danger btn-rounded btn-sm" data-toggle="tooltip" data-placement="top" title="Supprimer" onClick="delete_row('<?php echo $v->idforme; ?>','<?php echo $this->request->controller; ?>');"><span class="fa fa-times"></span></button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
