...
<head>
    ...
    <link rel="stylesheet" type="text/css" id="theme"
          href="<?php echo BASE_URL . '/koudjine/css/theme-default.css'; ?>"/>
...
<div class="page-container <?php if ($this->request->controller == 'medias') {
    ...
    <div class="page-sidebar scroll">
        ...
        <ul class="x-navigation">
            ...
            <li>
                <a href="index.html"
                   style="font-size: 20px;background-color: #b64645;text-align: center;align-content: center;align-items: center;justify-content: center;display: flex;">ALSAS</a>
                <a href="#" class="x-navigation-control"></a>
            </li>
            <li class="xn-profile">
                <a href="#" class="profile-mini">
                    <img src="<?php echo BASE_URL . '/koudjine/assets/images/users/' . $this->Session->user('PHOTO_PROFIL'); ?>"
                         alt="<?php echo $this->Session->user('NOM') . ' ' . $this->Session->user('PRENOM'); ?>"/>
                </a>
                <div class="profile">
                    ...
                    <div class="profile-controls">
                        <a href="<?php echo Router::url('bouwou/pharmanet/userprofile/' . $_SESSION["User"]->nom); ?>"
            ...
            <li <?php if ($this->request->controller == 'home') { ?>class="active" <?php } ?>>
                <a href="<?php echo Router::url('bouwou/home'); ?>"><span class="fa fa-desktop"></span> <span
                            class="xn-text">Tableau de bord</span></a>
            </li>
            <li class="xn-title">Etudes</li>

            <li <?php if (!in_array($this->Session->user('type'), Conf::$acces['vente'])) { ?>style="display: none" <?php } ?>
                class="xn-openable <?php if ($this->request->controller == 'vente') { ?>active<?php } ?>">
                <a href="#"><span class="fa fa-shopping-cart "></span> <span class="xn-text">Vente</span></a>
                <ul>
                    <li <?php if ($this->request->controller == 'vente' && $this->request->action == 'vente') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/vente/vente'); ?>"><span class="fa lettre">L</span>Liste</a>
                    </li>
                    <li <?php if ($this->request->controller == 'vente' && $this->request->action == 'venteadd') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/vente/venteadd'); ?>"><span class="fa lettre">A</span>Ajouter</a>
                    </li>
                    <li <?php if ($this->request->controller == 'vente' && $this->request->action == 'reglement') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/vente/reglement'); ?>"><span class="fa lettre">R</span>
                            Règlement</a></li>
                    <li <?php if ($this->request->controller == 'vente' && $this->request->action == 'chiffreaffaire') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/vente/chiffreaffaire'); ?>"><span
                                    class="fa lettre">C</span> Chiffre d'affaire</a></li>
                </ul>
            </li>
            <li <?php if (!in_array($this->Session->user('type'), Conf::$acces['catalogue'])) { ?>style="display: none" <?php } ?>
                class="xn-openable <?php if ($this->request->controller == 'catalogue') { ?>active<?php } ?>">
                ...
                <ul>
                    <li class="xn-openable <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'produit' || $this->request->controller == 'catalogue' && $this->request->action == 'produitadd' || $this->request->controller == 'catalogue' && $this->request->action == 'produitdetail') { ?>active <?php } ?>">
                        ...
                        <ul>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'produit') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/produit'); ?>"><span
                                            class="fa lettre">L</span> Lister</a></li>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'produitdetail') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/produitdetail'); ?>"><span
                                            class="fa lettre">L</span> Lister detail</a></li>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'produitadd') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/produitadd'); ?>"><span
                                            class="fa lettre">A</span> Ajouter</a></li>
                    ...
                    <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'categorie') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/catalogue/categorie'); ?>"><span
                                    class="fa lettre">C</span> Categorie</a></li>
                    <li class="xn-openable <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'prescripteur' || $this->request->controller == 'catalogue' && $this->request->action == 'prescripteuradd') { ?>active <?php } ?>">
                        ...
                        <ul>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'prescripteur') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/prescripteur'); ?>"><span
                                            class="fa lettre">L</span> Lister</a></li>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'prescripteuradd') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/prescripteuradd'); ?>"><span
                                            class="fa lettre">A</span> Ajouter</a></li>
                        </ul>
                    </li>
                    <li class="xn-openable <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'assureur' || $this->request->controller == 'catalogue' && $this->request->action == 'assureuradd') { ?>active <?php } ?>">
                        ...
                        <ul>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'assureur') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/assureur'); ?>"><span
                                            class="fa lettre">L</span> Lister</a></li>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'assureuradd') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/assureuradd'); ?>"><span
                                            class="fa lettre">A</span> Ajouter</a></li>
                        </ul>
                    </li>
                    <li class="xn-openable <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'client' || $this->request->controller == 'catalogue' && $this->request->action == 'clientadd') { ?>active <?php } ?>">
                        ...
                        <ul>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'client') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/client'); ?>"><span class="fa lettre">L</span>
                                    Lister</a></li>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'clientadd') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/clientadd'); ?>"><span
                                            class="fa lettre">A</span> Ajouter</a></li>
                        </ul>
                    </li>
                    <li class="xn-openable <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'fabriquant' || $this->request->controller == 'catalogue' && $this->request->action == 'fabriquantadd') { ?>active <?php } ?>">
                        ...
                        <ul>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'fabriquant') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/fabriquant'); ?>"><span
                                            class="fa lettre">L</span> Lister</a></li>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'fabriquantadd') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/fabriquantadd'); ?>"><span
                                            class="fa lettre">A</span> Ajouter</a></li>
                        </ul>
                    </li>
                    <li class="xn-openable <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'fournisseur' || $this->request->controller == 'catalogue' && $this->request->action == 'fournisseuradd') { ?>active <?php } ?>">
                        ...
                        <ul>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'fournisseur') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/fournisseur'); ?>"><span
                                            class="fa lettre">L</span> Lister</a></li>
                            <li <?php if ($this->request->controller == 'catalogue' && $this->request->action == 'fournisseuradd') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/catalogue/fournisseuradd'); ?>"><span
                                            class="fa lettre">A</span> Ajouter</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li <?php if (!in_array($this->Session->user('type'), Conf::$acces['geonetliste'])) { ?>style="display: none" <?php } ?>
                class="xn-openable <?php if ($this->request->controller == 'geonetliste') { ?>active<?php } ?>">
                <a href="#"><span class="fa fa-archive"></span> <span class="xn-text">Géonetliste</span></a>
                <ul>
                    <li <?php if ($this->request->controller == 'geonetliste' && $this->request->action == 'rayon') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/geonetliste/rayon'); ?>"> <span
                                    class="fa lettre">R</span>Rayon</a></li>
                    <li <?php if ($this->request->controller == 'geonetliste' && $this->request->action == 'magasin') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/geonetliste/magasin'); ?>"> <span
                                    class="fa lettre">M</span>Magasin</a></li>
                    <li <?php if ($this->request->controller == 'geonetliste' && $this->request->action == 'forme') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/geonetliste/forme'); ?>"><span
                                    class="fa lettre">F</span> Forme</a></li>
                    <li <?php if ($this->request->controller == 'geonetliste' && $this->request->action == 'unite') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/geonetliste/unite'); ?>"> <span
                                    class="fa lettre">U</span>Unite</a></li>
                    <li <?php if ($this->request->controller == 'geonetliste' && $this->request->action == 'ville') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/geonetliste/ville'); ?>"> <span
                                    class="fa lettre">V</span>Ville</a></li>
                    </li>
                </ul>
            </li>
            <li <?php if (!in_array($this->Session->user('type'), Conf::$acces['comptabilite'])) { ?>style="display: none" <?php } ?>
                class="xn-openable <?php if ($this->request->controller == 'comptabilite') { ?>active<?php } ?>">
                <a href="#"><span class="fa fa-credit-card"></span> <span class="xn-text">Comptabilite</span></a>
                <ul>
                    <li <?php if ($this->request->controller == 'comptabilite' && $this->request->action == 'budget') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/comptabilite/budget'); ?>"><span
                                    class="fa lettre">B</span>budget</a></li>
                    <li class="xn-openable <?php if ($this->request->controller == 'comptabilite' && $this->request->action == 'caisse' || $this->request->controller == 'comptabilite' && $this->request->action == 'caisse_rapport' || $this->request->controller == 'comptabilite' && $this->request->action == 'caisse_fermer') { ?>active <?php } ?>">
                        ...
                        <ul>
                            <li <?php if ($this->request->controller == 'comptabilite' && $this->request->action == 'caisse') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/comptabilite/caisse'); ?>"><span
                                            class="fa lettre">O</span> Ouvert</a></li>
                            <li <?php if ($this->request->controller == 'comptabilite' && $this->request->action == 'caisse_rapport') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/comptabilite/caisse_rapport'); ?>"><span
                                            class="fa lettre">R</span> Rapport</a></li>
                    ...
                    <li <?php if ($this->request->controller == 'comptabilite' && $this->request->action == 'consultation') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/comptabilite/consultation'); ?>"><span
                                    class="fa lettre">C</span> Consultation</a></li>
                    <li class="xn-openable <?php if ($this->request->controller == 'comptabilite' && $this->request->action == 'entre' || $this->request->controller == 'comptabilite' && $this->request->action == 'entreadd') { ?>active <?php } ?>">
                        ...
                        <ul>
                            <li <?php if ($this->request->controller == 'comptabilite' && $this->request->action == 'entre') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/comptabilite/entre'); ?>"><span
                                            class="fa lettre">L</span> Liste</a></li>
                            <li <?php if ($this->request->controller == 'comptabilite' && $this->request->action == 'entreadd') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/comptabilite/entreadd'); ?>"><span
                                            class="fa lettre">A</span> Ajouter</a></li>
                        </ul>
                    </li>
                    <li class="xn-openable <?php if ($this->request->controller == 'comptabilite' && $this->request->action == 'sortie' || $this->request->controller == 'comptabilite' && $this->request->action == 'sortieautre') { ?>active <?php } ?>">
                        ...
                        <ul>
                            <li <?php if ($this->request->controller == 'comptabilite' && $this->request->action == 'sortie') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/comptabilite/sortie'); ?>"><span
                                            class="fa lettre">D</span> Detail</a></li>
                            <li <?php if ($this->request->controller == 'comptabilite' && $this->request->action == 'sortieautre') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/comptabilite/sortieautre'); ?>"><span
                                            class="fa lettre">A</span> Autre sortie</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li <?php if (!in_array($this->Session->user('type'), Conf::$acces['commande'])) { ?>style="display: none" <?php } ?>
                class="xn-openable <?php if ($this->request->controller == 'commande') { ?>active<?php } ?>">
                ...
                <ul>
                    <li <?php if ($this->request->controller == 'commande' && $this->request->action == 'simplereappro') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/commande/simplereappro'); ?>"><span
                                    class="fa lettre">S</span>Simple réappro</a></li>
                    <li <?php if ($this->request->controller == 'commande' && $this->request->action == 'cmdprogramme') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/commande/cmdprogramme'); ?>"><span
                                    class="fa lettre">C</span>Commande express</a></li>
                    <li <?php if ($this->request->controller == 'commande' && $this->request->action == 'list') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/commande/list'); ?>"><span class="fa lettre">L</span>Liste
                            de commande</a></li>
                    <li <?php if ($this->request->controller == 'commande' && $this->request->action == 'cmdparticuliere') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/commande/cmdparticuliere'); ?>"><span class="fa lettre">C</span>Commande
                            particulière</a></li>
                </ul>
            </li>
            <li <?php if (!in_array($this->Session->user('type'), Conf::$acces['stock'])) { ?>style="display: none" <?php } ?>
                class="xn-openable <?php if ($this->request->controller == 'stock') { ?>active<?php } ?>">
                <a href="#"><span class="fa fa-bank"></span> <span class="xn-text">Stock</span></a>
                <ul>
                    <li <?php if ($this->request->controller == 'stock' && $this->request->action == 'inventaire') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/stock/inventaire'); ?>"><span class="fa lettre">I</span>Inventaire</a>
                    </li>
                </ul>
            </li>
            <li <?php if (!in_array($this->Session->user('type'), Conf::$acces['statistique'])) { ?>style="display: none" <?php } ?>
                class="xn-openable <?php if ($this->request->controller == 'statistique') { ?>active<?php } ?>">
                <a href="#"><span class="fa fa-bar-chart-o"></span> <span class="xn-text">Statistique</span></a>
                <ul>
                    <li <?php if ($this->request->controller == 'statistique' && $this->request->action == 'produitplusvendu') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/statistique/produitplusvendu'); ?>"><span
                                    class="fa lettre">P</span>Produit plus vendu</a></li>
                    <li <?php if ($this->request->controller == 'statistique' && $this->request->action == 'chiffre') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/statistique/chiffre'); ?>"><span
                                    class="fa lettre">C</span>Chiffre</a></li>
                </ul>
            </li>
            <li <?php if (!in_array($this->Session->user('type'), Conf::$acces['pharmanet'])) { ?>style="display: none" <?php } ?>
                class="xn-openable <?php if ($this->request->controller == 'pharmanet') { ?>active<?php } ?>">
            ...
            <li <?php if (!in_array($this->Session->user('type'), Conf::$acces['pharmanet'])) { ?>style="display: none" <?php } ?>
                ...
                <ul>
                    <li <?php if ($this->request->controller == 'pharmanet' && $this->request->action == 'configuration') { ?>class="active" <?php } ?>>
                        <a href="<?php echo Router::url('bouwou/pharmanet/configuration'); ?>"><span
                                    class="fa lettre">C</span>Configuration</a></li>
                    <li class="xn-openable <?php if ($this->request->controller == 'pharmanet' && $this->request->action == 'employe' || $this->request->controller == 'pharmanet' && $this->request->action == 'employeadd') { ?>active <?php } ?>">
                        ...
                        <ul>
                            <li <?php if ($this->request->controller == 'pharmanet' && $this->request->action == 'employe') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/pharmanet/employe'); ?>"><span
                                            class="fa lettre">L</span> Lister</a></li>
                            <li <?php if ($this->request->controller == 'pharmanet' && $this->request->action == 'employeadd') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/pharmanet/employeadd'); ?>"><span
                                            class="fa lettre">A</span> Ajouter</a></li>
                        </ul>
                    </li>
                    <li class="xn-openable <?php if ($this->request->controller == 'pharmanet' && $this->request->action == 'user' || $this->request->controller == 'pharmanet' && $this->request->action == 'useradd') { ?>active <?php } ?>">
                        ...
                        <ul>
                            <li <?php if ($this->request->controller == 'pharmanet' && $this->request->action == 'user') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/pharmanet/user'); ?>"> <span
                                            class="fa lettre">L</span>Lister</a></li>
                            <li <?php if ($this->request->controller == 'pharmanet' && $this->request->action == 'useradd') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/pharmanet/useradd'); ?>"><span
                                            class="fa lettre">A</span> Ajouter</a></li>
                        </ul>
                    </li>
                    <li class="xn-openable <?php if ($this->request->controller == 'pharmanet' && $this->request->action == 'list' || $this->request->controller == 'pharmanet' && $this->request->action == 'depenseadd') { ?>active <?php } ?>">
                        ...
                        <ul>
                            <li <?php if ($this->request->controller == 'pharmanet' && $this->request->action == 'list') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/pharmanet/list'); ?>"> <span
                                            class="fa lettre">L</span>Recherche</a></li>
                            <li <?php if ($this->request->controller == 'pharmanet' && $this->request->action == 'depenseadd') { ?>class="active" <?php } ?>>
                                <a href="<?php echo Router::url('bouwou/pharmanet/depenseadd'); ?>"><span
                                            class="fa lettre">A</span> Ajouter dépense</a></li>
                        </ul>
                    </li>
    ...
    <div class="page-content">
        ...
        <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
            ...
            <li class="xn-icon-button pull-right">
                <a href="<?php echo Router::url('users/logout'); ?>" class="mb-control" data-box="#mb-signout"><span
                            class="fa fa-sign-out" data-toggle="tooltip" data-placement="bottom"
                            title="Déconnexion"></span></a>
            </li>
            <!-- END SIGN OUT -->
            <!-- MESSAGES -->
            <!-- <li class="xn-icon-button pull-right">
        ...
        <div class="page-title">
            ...
            <?php if (isset($action_for_layout)) { ?>
                <button class="btn btn-primary ajouter pull-right"
                        controller="<?php echo $this->request->controller; ?>"
                        data="<?php if (isset($this->request->params[0])) echo $this->request->params[0]; ?>"
                        id="<?php echo $this->request->url; ?>"><?php echo $action_for_layout; ?></button> <?php } ?>
        </div>
        <!-- END PAGE TITLE -->
...
<div class="message-box animated fadeIn" data-sound="alert" id="mb-confirmation-print" data="">
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <div class="mb-content">
                <p>Voulez vous imprimer un <strong>
                        <mark>Ticket de caisse</mark>
                    </strong>?
                </p>
...
<script type="text/javascript"
        src="<?php echo BASE_URL . '/koudjine/js/plugins/bootstrap/bootstrap.min.js'; ?>"></script>
<!-- END PLUGINS -->

<script type='text/javascript' src="<?php echo BASE_URL . '/koudjine/js/plugins/icheck/icheck.min.js'; ?>"></script>
<script type='text/javascript'
        src="<?php echo BASE_URL . '/koudjine/js/plugins/scrolltotop/scrolltopcontrol.js'; ?>"></script>
<script type="text/javascript"
        src="<?php echo BASE_URL . '/koudjine/js/plugins/mcustomscrollbar/jquery.mCustomScrollbar.min.js'; ?>"></script>
...
<script type="text/javascript"
        src="<?php echo BASE_URL . '/koudjine/js/plugins/datatables/jquery.dataTables.min.js'; ?>"
"></script>
<
script
type = " text/javascript"
src = "<?php echo BASE_URL . '/koudjine/js/plugins/tableexport/tableExport.js'; ?>"
"></script>
<script type=" text/javascript" src="<?php echo BASE_URL . '/koudjine/js/plugins/tableexport/jquery.base64.js'; ?>"
"></script>
<
script
type = " text/javascript"
src = "<?php echo BASE_URL . '/koudjine/js/plugins/tableexport/html2canvas.js'; ?>"
"></script>
<script type=" text/javascript" src="<?php echo BASE_URL . '/koudjine/js/plugins/tableexport/jspdf/libs/sprintf.js'; ?>"
"></script>
<
script
type = " text/javascript"
src = "<?php echo BASE_URL . '/koudjine/js/plugins/tableexport/jspdf/jspdf.js'; ?>"
"></script>
<script type=" text/javascript" src="<?php echo BASE_URL . '/koudjine/js/plugins/tableexport/jspdf/libs/base64.js'; ?>"
"></script>

<
script
type = "text/javascript"
src = "<?php echo BASE_URL . '/koudjine/js/plugins/noty/jquery.noty.js'; ?>"
"></script>
<script type="text/javascript" src="<?php echo BASE_URL . '/koudjine/js/plugins/noty/layouts/topCenter.js'; ?>"
"></script>
<
script
type = "text/javascript"
src = "<?php echo BASE_URL . '/koudjine/js/plugins/noty/layouts/topRight.js'; ?>"
"></script>
<script type="text/javascript" src="<?php echo BASE_URL . '/koudjine/js/plugins/noty/layouts/topLeft.js'; ?>"
"></script>
<
script
type = "text/javascript"
src = "<?php echo BASE_URL . '/koudjine/js/plugins/noty/themes/default.js'; ?>"
"></script>
