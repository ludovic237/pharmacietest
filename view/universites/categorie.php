...
if($this->request->action == "index"){
    ...
    $position = $universites[0]->nomt;
}
$position_for_layout = '<li><a href="'.BASE_URL.'/universites">Universités</a></li><li class="active">'.$position.'</li>';
...
<div class="block-heading this-animate" data-animate="fadeInLeft">
    ...
    <div class="block-heading-text">
        Liste de tous les universités existant sur le territoire camerounais avec leurs écoles partenaires, la ville où vous pouvez les trouver, le type d'enseignement qu'il donne ainsi que le secteur auquel ils appartiennent.
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="row mix-grid thumbnails">
                ...
                foreach ($universites as $k => $v):
                    ...
                    echo "<h6><a href=\"presentation.php?univ_id=".$v->id."\">".$v->nom."</a></h6>"."\n";
                    echo "<span class=\"blog-date\">".$v->ville."</span>"."\n";
                    echo "<p class=\"type\">".$v->nomt."</p>"."\n";
                    echo "</div>"."\n";
                    echo "</div>"."\n";
                endforeach; ?>
            </div>
