...
<div class="page-content-holder">
    ...
    <div class="block-heading block-heading-centralized this-animate" data-animate="fadeInDown">
        <div class="text-center">
            <a href="<?php echo BASE_URL.'/orientation/interets_professionnels';?>" class="btn btn-default btn-xl faq-title"><span class="fa" style="font-weight: 400;">1</span> Intérêts professionnels</a> <a href="<?php echo BASE_URL.'/orientation/personnalite';?>" class="btn btn-primary btn-xl faq-title"><span class="fa">2</span> Personnalité</a>
        </div>
    </div>
