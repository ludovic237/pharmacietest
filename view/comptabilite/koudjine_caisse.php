               ...
               <div class="panel-body panel-body-table">
                    ...
                    <div class="panel-body">
                         <div style="justify-content:space-evenly;display:flex">
                              <button class="btn btn-primary ajouter pull-right" controller="comptabilite" data="" id="" onclick="close_caisse_row()">Fermer caisse</button>
     ...
     <div class="modal-dialog">
          <div class="modal-content">
                                                  ...
                                                  <table class="table  table-bordered table-striped table-actions">
                                                       ...
                                                       <tbody>
                                                            ...
                                                            <tr>
                                                                 ...
                                                                 <td>
                                                                      <h6 style="margin-bottom: 0px;"><span class="soustotalaisse1"></span></h6>
                                                                 </td>
                                                                 <td>
                                                                      <h6>
                                                                           Sous total
                                                                 ...
                                                                 <td>
                                                                      <h6 style="margin-bottom: 0px;"><span class="soustotalaisse2"></span></h6>
                                                                 </td>
                                                            </tr>
                                                            <tr>
                                                                 <td colspan="4">
                                                                      <div style="justify-content: space-between;display:flex">
                                                                           ...
                                                                           <h4 style="margin-bottom: 0px;"><span class="totalaisse"></span></h4>
                                                                      </div>
                                                                 </td>
                                                            </tr>
                                                       </tbody>
               ...
               <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal" style="margin-right: 20px;" onclick="close_caisse_row_valide()">Valider</button>
...
<div class="modal fade" id="iconPreviewCaisseFermer" tabindex="-1" role="dialog" aria-hidden="false">
     <div class="modal-dialog">
          <div class="modal-content">
               ...
               <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal" style="margin-right: 20px; " onclick="valider_fermeture()">Valider</button>
                    <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
               </div>
          </div>
     </div>
