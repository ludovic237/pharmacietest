...
$page_for_layout = ($position == 'Ajouter') ? 'Ajouter un detail' : 'Modifier un detail';
...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="block">
            <h4 style="padding: 10px 20px;background-color: #2d3945;color: white;">Nouveau detail</h4>
            <form id="jvalidate" role="form" class="form-horizontal" action="javascript:enregistrer_universite('<?php echo $position; ?>','<?php if ($position == 'Modifier')  echo $universites->UNIVERSITE_ID;
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-md-3 control-label">Recherche:</label>
                        <div class="col-md-9">
