            ...
            <div class="panel-body">
                ...
                <div class="block">
                    ...
                    <form id="jvalidate" role="form" class="form-horizontal"
                          action="javascript:enregistrer_fournisseur('<?php echo $position; ?>','<?php if ($position == 'Modifier') echo $fournisseur->id;
                          else echo ""; ?>');">
                        <div class="panel-body">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="nom" id="nom"
                                           value="<?php if ($position == 'Modifier') echo $fournisseur->nom; ?>"
                                           placeholder=""/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="telephone" id="telephone"
                                           value="<?php if ($position == 'Modifier') echo $fournisseur->telephone; ?>"
                                           placeholder=""/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="adresse" id="adresse"
                                           value="<?php if ($position == 'Modifier') echo $fournisseur->adresse; ?>"
                                           placeholder=""/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="email" id="email"
                                           value="<?php if ($position == 'Modifier') echo $fournisseur->email; ?>"
                                           placeholder=""/>
                                    ...
                                    <select class="selectpicker form-control input-xlarge " name="statut" id="statut">
                                        ...
                                        if ($position == 'Modifier') {
                                            if ($fournisseur->statut == 'Grossiste') {
                                                echo '<option value="Grossiste">Grossiste</option> <option value="Detaillant">Detaillant</option>';
                                            } else {
                                                echo '<option value="Detaillant">Detaillant</option> <option value="Grossiste">Grossiste</option>';
                                            }

                                        } else echo '<option value="Grossiste">Grossiste</option> <option value="Detaillant">Detaillant</option>'
                                        ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="codepostal" id="codepostal"
                                           value="<?php if ($position == 'Modifier') echo $fournisseur->codepostal; ?>"
                                           placeholder=""/>
                            ...
                            <div class="btn-group pull-right">
                                <a class="btn btn-primary" style="margin-right: 20px"
                                   href="<?php echo Router::url('bouwou/catalogue/fournisseur'); ?>">Annuler</a>
