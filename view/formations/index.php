                    ...
                    for ($i="A"; $i <= "D" ; $i++) {
                        if(!empty($formations[$i])){
                            ...
                            foreach ($formations[$i] as $k => $v):
                                ...
                                echo "<a href=\"".BASE_URL."/formations/categorie/".${$variable}['nomcategorie']->SLUG."\"><p class=\"text-success\">".${$variable}['nomcategorie']->NOM."</p></a>";
                    ...
                    for ($i = "E"; $i <= "H"; $i++) {
                        if(!empty($formations[$i])){
                            ...
                            foreach ($formations[$i] as $k => $v):
                                ...
                                echo "<li class=\"list-group-item\">";
                                echo "<span class=\"contacts-title\">".$v->NOM."</span>";
                                echo "<a href=\"".BASE_URL."/formations/categorie/".${$variable}['nomcategorie']->NOM."\"><p class=\"text-success\">".${$variable}['nomcategorie']->NOM."</p></a>";
                                echo "<div class=\"list-group-controls\">";
                                ?>
                                <span class="badge badge-danger" data-toggle="tooltip" data-placement="top" title="
                                <?php
