...
sEmptyTable:"No data available in table",sInfo:"Affiche _START_ à _END_ de _TOTAL_ lignes",sInfoEmpty:"Affiche 0 à 0 de 0 lignes",sInfoFiltered:"(filtered from _MAX_ total lignes)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Affiche _MENU_ lignes",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Recherche Rapide:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
...
sSortIcon:"DataTables_sort_icon",sScrollHead:"dataTables_scrollHead "+E,sScrollFoot:"dataTables_scrollFoot "+E,sHeaderTH:E,sFooterTH:E,sJUIHeader:Ub+" ui-corner-tl ui-corner-tr",sJUIFooter:Ub+" ui-corner-bl ui-corner-br"});var Lb=p.ext.pager;h.extend(Lb,{simple:function(){return["précédent","suivant"]},full:function(){return["first","previous","next","last"]},simple_numbers:function(a,b){return["previous",Ua(a,b),"next"]},full_numbers:function(a,b){return["first","previous",Ua(a,b),"next","last"]},_numbers:Ua,
