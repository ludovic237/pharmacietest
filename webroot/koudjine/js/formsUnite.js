        ...
        return this.each(function () {
            var th = $(this)
                , _ = th.data('forms') || {
                    ...
                    successCl: 'success',
                    successShow: '4000',
                    mailHandlerURL: '/pharmacietest/koudjine/inc/unite.php',
                    ...
                    , submitFu: function () {
                        ...
                        if (!_.form.has('.' + _.invalidCl).length) {
                            ...
                            var libelle = _.getValFromLabel($('.libelle', _.form));
                            ...
                            if ($('.button').html() == "Ajouter") {
                                    ...
                                    success: function (data) {
                                        ...
                                        if (data.erreur == 'non') {
                                            var cat = '<tr id="' + data.id + '">'
                                                ...
                                                + '<td>' + libelle + '</td>'
                                                + '<td>'
                                                + '<button class="btn btn-default btn-rounded btn-sm" onClick="update_row_unite(' + data.id + ');"><span class="fa fa-pencil"></span></button>'
                                                + '<button class="btn btn-danger btn-rounded btn-sm" onClick="delete_row(' + data.id + ');"><span class="fa fa-times"></span></button>'
                                                + '</td>'
                                                + '</tr>';


                                            $('#tableau_unite').prepend(cat);
                                        }
                                        else {
                                ...
                                /*$.ajax({
                                 ...
                                 libelle: _.getValFromLabel($('.libelle',_.form))
                                 },
                                 success: function(data){
                                    ...
                                    success: function (data) {
                                        ...
                                        if (data.erreur == 'non') {
                                            $("#" + lien + " td").each(function (i) {
                                                ...
                                                if (i == 1) $(this).html(libelle);

                                            });
                                            $('.button').html('Ajouter');
                                            $('.titre').html('Ajouter un nouveau unite');
