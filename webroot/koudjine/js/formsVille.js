        ...
        return this.each(function(){
            var th=$(this)
                ,_=th.data('forms')||{
                        ...
                        successCl:'success',
                        successShow:'4000',
                        mailHandlerURL:'/pharmacietest/koudjine/inc/ville.php',
                                            ...
                                            noty({ text: 'Information enregistré', layout: 'topRight', type: 'success' });
                                                if (data.erreur == 'non') {
                                                    var cat = '<tr id="' + data.id + '">'
                                                        ...
                                                        + '<td>' + code + '</td>'
                                                        + '<td>'
                                                        + '<button class="btn btn-default btn-rounded btn-sm" onClick="update_row_ville(' + data.id + ');"><span class="fa fa-pencil"></span></button>'
                                                        + '<button class="btn btn-danger btn-rounded btn-sm" onClick="delete_row(' + data.id + ');"><span class="fa fa-times"></span></button>'
                                                        + '</td>'
                                                        + '</tr>';


                                                    $('#tableau_ville').prepend(cat);
                                                }
                                                else{
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data){
                                            ...
                                            if(data.erreur == 'non' ){
                                                ...
                                                $('.button').html('Ajouter');
                                                $('.titre').html('Ajouter un nouveau ville');
