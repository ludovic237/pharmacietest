...
var site_settings = '<div class="ts-button">'
    ...
    + '<div class="ts-themes">'
    + '<a href="#" class="active" data-theme="/Site/koudjine/css/theme-default.css"><img src="/Site/koudjine/img/themes/default.jpg"/></a>'
    + '<a href="#" data-theme="/Site/koudjine/css/theme-forest.css"><img src="/Site/koudjine/img/themes/forest.jpg"/></a>'
    + '<a href="#" data-theme="/Site/koudjine/css/theme-dark.css"><img src="/Site/koudjine/img/themes/dark.jpg"/></a>'
    + '<a href="#" data-theme="/Site/koudjine/css/theme-night.css"><img src="/Site/koudjine/img/themes/night.jpg"/></a>'
    + '<a href="#" data-theme="/Site/koudjine/css/theme-serenity.css"><img src="/Site/koudjine/img/themes/serenity.jpg"/></a>'

    + '<a href="#" data-theme="/Site/koudjine/css/theme-default-head-light.css"><img src="/Site/koudjine/img/themes/default-head-light.jpg"/></a>'
    + '<a href="#" data-theme="/Site/koudjine/css/theme-forest-head-light.css"><img src="/Site/koudjine/img/themes/forest-head-light.jpg"/></a>'
    + '<a href="#" data-theme="/Site/koudjine/css/theme-dark-head-light.css"><img src="/Site/koudjine/img/themes/dark-head-light.jpg"/></a>'
    + '<a href="#" data-theme="/Site/koudjine/css/theme-night-head-light.css"><img src="/Site/koudjine/img/themes/night-head-light.jpg"/></a>'
    + '<a href="#" data-theme="/Site/koudjine/css/theme-serenity-head-light.css"><img src="/Site/koudjine/img/themes/serenity-head-light.jpg"/></a>'
...
$(document).ready(function () {
   ...
   /*if (localStorage.getItem('theme')) {
       ...
       /!* console.log(localStorage.getItem('theme'));
        ...
        $("#theme").attr("href", param1.data("theme"));*!/
    }*/
