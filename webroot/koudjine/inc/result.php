...
if (isset($_GET["motclef1"])) {
    ...
    $sth = $pdo->prepare("
              SELECT p.nom, r.quantite, r.reduction, p.reductionMax, r.prixVente, r.id as id, r.dateLivraison 
    ...
    if ($count) {
        while ($result = $sth->fetch(PDO::FETCH_OBJ)) {
            ...
            echo "<tr id=\"R".$result->id."\">
                                            ...
                                            <td>
                                                <button class=\"btn btn-primary \" data-toggle=\"tooltip\" data-placement=\"top\" onclick=\"ajouter_produit('".$result->id."')\"><span class=\"\">Ajouter</span></button>
                                            </td>
                                        </tr>";
