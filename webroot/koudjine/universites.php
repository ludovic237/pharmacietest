        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">   
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            <li class="active"><a href="#"> Toutes les universités</a></li>
                            <li><a href="edit_universite.php"><span class="fa">A</span> Ajouter</a></li>
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>Universités</li>
                    <li class="active">Toutes les universités</li>
                </ul>
                <!-- END BREADCRUMB -->

                <!-- PAGE TITLE -->
                <div class="page-title">
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Universités</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 scroll">
                                <ul class="list-group border-bottom">
                                    ...
                                    <li class="list-group-item responsable" style="margin-bottom: 20px"></li>
                                    <h4>Informations de contact</h4>
                                    <li class="list-group-item bp"></li>
                                    <li class="list-group-item phone"</li>
                                    <li class="list-group-item email"></li>
                                    <li class="list-group-item site" style="margin-bottom: 20px"></li>
                                    <h4>Autres Informations</h4>
                                    <li class="list-group-item certif"></li>
                                    <li class="list-group-item parrain"></li>
                                </ul>
                            </div>
                        </div>
                    </div>
