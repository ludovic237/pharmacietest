        ...
        <div class="page-container">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="#"> Facultés</a></li>
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>Universités</li>
                    <li class="active">Facultés</li>
                </ul>
                <!-- END BREADCRUMB -->

                <!-- PAGE TITLE -->
                <div class="page-title">
                    <h2><span class="fa fa-arrow-circle-o-left"></span>Facultés</h2>
                </div>
                <!-- END PAGE TITLE -->
                                    ...
                                    <form id="form1" class="form-horizontal" method="post">
                                        <div class="panel-body">
                                            ...
                                            <div class="btn-group pull-left">
                                                <div class="btns"><a href="#" class="button btn btn-primary pull-left"
                                                                     data-type="submit">Ajouter</a></div>
                                            </div>
                                        </div>
                                    </form>
